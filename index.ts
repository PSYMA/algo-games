...
function PlaySnake() {
    ...
    let ctx: CanvasRenderingContext2D = canvas.getContext("2d");
    let canvasWrapperRect = document.getElementById("Snake").getBoundingClientRect();
    canvas.width = canvasWrapperRect.width;
...
document.getElementById("SnakeClick").onclick = function () {
    document.title = "Snake Game";
    document.getElementById("Logo").innerHTML = "Snake Game";
